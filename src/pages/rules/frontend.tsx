      ...
      <main>
        <section id="how-it-works" className="mb-8">
          ...
          <p className="m-2 leading-relaxed text-gray-600">
            ...
            team loses or ties, you are eliminated from the pool. The goal is to
        ...
        <section id="elimination" className="mb-8">
          ...
          <ul className="m-2 space-y-4 text-gray-600">
            ...
            <li>
              If all remaining players fail to pick a winning team, all players
              survive the week.
            </li>
        ...
        <section id="winning" className="mb-8">
          ...
          <ul className="m-2 space-y-4 text-gray-600">
            <li>The last person remaining in the pool wins the pot.</li>
            <li>
              If the pool reaches the end of the regular season and there is
              more than one survivor, the pot will be split equally among all
              remaining survivors.
            </li>
            <li>
              In the event of a tie for the final survivor, tiebreaker rules may
              be used (e.g., total points scored by winning picks, etc.).
            </li>
          </ul>
        </section>
      </main>
